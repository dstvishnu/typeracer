//Key board type code for space=96
//Get the Content,showProgress,hideProgress,getUserInput,showIndicator,updateColour
//<Content contentId="racerContent" contentClass="content" content={this.state.content}/>  
...
class Layout extends Component {
  ...
  handleTextChanges = () => {
    ...
    if (lastChar === ' ') {
      if (this.state.textValue === this.state.remainingWordsArray[0] + ' ') {
